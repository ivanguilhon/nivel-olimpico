...
async function getQuestion(id: string) {
  ...
  const { data, error } = await supabase
    .from('questions')
    .select(`id, title, body, vote_count, view_count, is_solved, created_at, author_id, author:profiles(id, display_name), question_tags(tags(id, name, color, category)), answers(id, body, vote_count, is_accepted, created_at, author_id, author:profiles(id, display_name))`)
    .eq('id', id)
    .single() as any
