...
const courses = [
  ...
  },
  {
    ...
    benefits: ['Cobre o conteúdo cobrada na OBF e Olimpíadas Internacionais', 'Sem laboratório necessário', 'Professor com experiência em olimpíadas'],
    price: 'R$ 127',
    from: 'R$ 247',
  ...
  {
    tag: 'ESTRATÉGIA MILITARES E VESTIBULARES',
    ...
    benefits: ['Ensino fundamental e médio', 'Acesso ao banco de questões do Estratégia', '28h de aula gravada', '28 encontros ao vivo', 'Acompanhamento contínuo do professor Ivan'],
  ...
  },
  {
    ...
    desc: 'Introdução lúdica às ciências para os pequenos totalmente baseada em experimentos, despertando o interesse científico desde cedo. Sem pré-requisitos de matemática.',
    benefits: ['Recomendado para alunos do 3o ao 6o ano EM', 'Roteiro com lista de material e instruções para realização dos experimentos', 'Aulas 100% ao vivo.'],
      ...
      <section className="max-w-7xl mx-auto px-4 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ...
            { img: IMG.estudoEficaz, subtitle: 'Inteligência, Virtudes e Provas', title: 'Estudo Eficaz', desc: 'Como desenvolver inteligência, cultivar virtudes e ter alto desempenho em provas e exames.', links: [{l:'Ebook',h:'https://pay.hotmart.com/X72216388W'},{l:'Livro Físico',h:'https://vestseller.com.br/estudo%20eficaz%20-%20intelig%C3%AAncia,%20virtudes%20e%20provas%20-%20prof.%20dr.%20ivan%20guilhon%20mitoso%20rocha%20/1441.html'}] },
          ].map(book => (
